# staff
loot give @s loot tsp:daydream/item/staff

# alteration
loot give @s loot tsp:daydream/item/spells/alteration/oakflesh
loot give @s loot tsp:daydream/item/spells/alteration/stoneflesh
loot give @s loot tsp:daydream/item/spells/alteration/ironflesh
loot give @s loot tsp:daydream/item/spells/alteration/diamondflesh
